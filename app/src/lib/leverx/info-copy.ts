...
export const leverxInfo = {
  orderType:
    "Market orders open right away at the best available price. Limit orders let you set the most you are willing to pay — adjust slippage and expiry in settings.",
  marketSlippage:
