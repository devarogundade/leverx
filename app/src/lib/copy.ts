...
export const ui = {
  ...
  predictVaultHint: "Funds that back leveraged trades on demo markets",
  ...
  vaultPageTitle: "Pool",
  vaultPageHint:
    "Add USDC to the pool and earn from trading fees. Traders borrow from the pool when they use leverage.",
  ...
  vaultSupplyCta: "Deposit USDC",
  vaultWithdrawCta: "Withdraw USDC",
  vaultActionHint:
    "Deposit USDC to earn from trading activity, or withdraw your balance anytime. Connect your wallet first.",
