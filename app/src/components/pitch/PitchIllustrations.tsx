...
function ProblemIllustration() {
  const cards = [
    ...
    { label: "10×", tone: "muted", muted: true },
    { label: "LP", tone: "muted", muted: true },
  ] as const;
...
function LayersIllustration() {
  const layers = [
    { name: "LeverX", sub: "UI · Vault · Jarvis", accent: true },
    { name: "DeepBook Predict", sub: "Vol surface · Oracles", accent: false },
    { name: "Sui testnet", sub: "On-chain settlement", accent: false },
  ];
