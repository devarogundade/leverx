...
const STEPS: readonly WelcomeStep[] = [
  {
    ...
    bullets: [
      "Demo trading on Sui testnet — no real money",
      "Bet on where asset prices finish at expiry",
      "Settles against live oracle prices on DeepBook Predict",
    ],
  },
  {
  ...
  },
  {
    title: "Trade or earn",
    description:
      "Connect your wallet to open positions, or deposit dUSDC to the pool and earn from trading fees.",
