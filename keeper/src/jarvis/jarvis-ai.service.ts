...
export class JarvisAiService {
  ...
  private buildSystemPrompt(
    ...
    return [
      ...
      'Use tools to query or refine any detail before deciding. Call get_knowledge_base(topic) to refresh a section; get_platform_rules for bounds, health_interpretation_rules, and final-window / 1× / deleverage rule text.',
      ...
      'Respect platform_rules for leverage, margin, slippage, final_window_ms, health_interpretation_rules, and the rules text fields (final_window_rules, one_x_leverage_rules, force_deleverage_rules).',
