...
| Status | Signature |
|--------|-----------|
| ✅ | `create_lvlp_treasury`, `new`, `share`, `deposit_liquidity`, `withdraw_liquidity` |
...
events: CollateralDeposited | CollateralWithdrawn | CollateralSwapped
      | DebtBorrowed | DebtRepaid | LeveragedPositionOpened | LeveragedPositionClosed
      | PositionLiquidated | TriggersUpdated | TriggersCleared

// Vault dashboard
filter: vault_id == $vaultId
events: VaultSupplied | VaultWithdrawn | VaultBorrowed | VaultRepaid
      | InterestAccrued | ProtocolFeeDistributed | InsuranceFundSkimmed
